...
wsa.initHTML = function(){
	...
	css_text += '.wsa_open{background-image: -webkit-gradient(linear,left top,left bottom,color-stop(0,#0000A7),color-stop(1,#000046));  background-image: -moz-gradient(linear,left top,left bottom,color-stop(0,#0000A7),color-stop(1,#000046));  background-image: gradient(linear,left top,left bottom,color-stop(0,#0000A7),color-stop(1,#000046));  color: white;  font-style: italic;  font-weight: bold;  text-shadow: 1px 1px 5px #fff;  box-shadow: 0 2px 7px #A6A7E4;}';
